        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Opportunities_Descriptions_DescriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    FlowerExpertsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Experts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Experts_FlowerExperts_FlowerExpertsId",
                        column: x => x.FlowerExpertsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OurBlogId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Comments_OurBlogs_OurBlogId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_OurBlogId",
                table: "Comments",
                column: "OurBlogId");

            migrationBuilder.CreateIndex(
                name: "IX_Experts_FlowerExpertsId",
                table: "Experts",
                column: "FlowerExpertsId");

            migrationBuilder.CreateIndex(
                name: "IX_Opportunities_DescriptionId",
                table: "Opportunities",
